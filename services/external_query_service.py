...
class ExternalQueryService:
    ...
    async def run_query(self, query_name: str, date_from: str = None, date_to: str = None, currency: str = "USD") -> List[DBQueryResult]:
        ...
        financial_data: List[DBQueryResult] = []
                ...
                try:
                    ...
                    for row in records:
                        ...
                        try:
                            ...
                            financial_data.append(DBQueryResult(
                                date=date_val,
